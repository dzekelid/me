...
x-complete: 0
info:
  title: Stripe Get Payments Payment
...
paths:
  ...
  /ephemeral_keys/{key}:
    delete:
      ...
      x-api-path-slug: ephemeral-keyskey-delete
      parameters:
      - in: path
        name: key
        description: The ID of the key youd like to invalidate
      - in: body
        name: payload
        description: Body parameters for the request
        schema:
  ...
  /payments/{payment}:
    get:
      ...
      x-api-path-slug: paymentspayment-get
      parameters:
      - in: query
        name: expand
        description: Specifies which fields in the response should be expanded
