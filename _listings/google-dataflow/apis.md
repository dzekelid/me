...
created: "2018-06-20"
modified: "2018-06-20"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/me/master/_listings/google-dataflow/apis.md
...
- name: Google Cloud Dataflow API Send Worker Message
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/me/master/_listings/google-dataflow/v1b3projectsprojectidworkermessages-post-openapi.md
- name: Google Cloud Dataflow API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/me/master/_listings/google-dataflow/openapi.md
x-common:
- type: x-code
